...
export async function obtenerEstadosHerramienta() {
    try {
        ...
        console.error("Error al obtener los estados de herramienta: " + error);
        throw error;
    }
}
...
export async function obtenerEstadoHerramientaPorId(id) {
    try {
        ...
        console.error("Error al obtener el estado de herramienta por ID: " + error);
        throw error;
    }
}
...
export async function agregarEstadoHerramienta(estadoHerramienta) {
    try {
        const response = await fetch(API_URL, {
            ...
            body: JSON.stringify(estadoHerramienta)
        });
